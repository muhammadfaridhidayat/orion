    ...
    return (
      <main className="min-h-screen bg-[#050505] text-white pt-24 pb-16 flex items-center justify-center">
        ...
        <motion.div 
          ...
          className="max-w-md w-full glass-card p-10 rounded-3xl border border-green-500/30 text-center relative overflow-hidden"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/50 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500/50 transition-colors"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-black/50 border border-white/10 rounded-xl py-3 px-4 text-white focus:outline-none focus:border-blue-500/50 transition-colors appearance-none"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-black/50 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500/50 transition-colors resize-none"
