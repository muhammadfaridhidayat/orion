...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-white/[0.03] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-emerald-100/[0.03] rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {cards.map((card, index) => (
            ...
            >
              <div className="mb-6 w-16 h-16 rounded-full border border-gray-800 glass flex items-center justify-center">
                {card.icon}
              </div>
